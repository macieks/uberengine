...
/**
 * The contributor element defines uethoring information for asset management
 */
...
/**
 * The uethor element contains a string with the uethor's name. There may
 * be only one uethor element.
 */
...
/**
 * The uethoring_tool element contains a string with the uethoring tool's
 * name. There may be only one uethoring_tool element.
 */
...
/**
 * The uethor element contains a string with the uethor's name. There may
 * be only one uethor element. @see domAuthor
 */
		domAuthorRef elemAuthor;
/**
 * The uethoring_tool element contains a string with the uethoring tool's
 * name. There may be only one uethoring_tool element. @see domAuthoring_tool
 */
 ...
 */
	...
	public:	//Accessors and Mutators
		/**
		 * Gets the uethor element.
		 * @return a daeSmartRef to the uethor element.
		 */
		const domAuthorRef getAuthor() const { return elemAuthor; }
		/**
		 * Gets the uethoring_tool element.
		 * @return a daeSmartRef to the uethoring_tool element.
		 */
