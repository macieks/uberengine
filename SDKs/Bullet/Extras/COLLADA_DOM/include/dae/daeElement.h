...
public:
	 ...
	 * children. This uetomatically adds the new element to the <tt><i> _contents </i></tt> of its parent, if the parent has one.  
	 *
	 ...
	 * This uetomatically adds the new element to the <tt><i> _contents </i></tt> of its parent, if the parent has one.  
	 ...
	 * This also uetomatically inserts the new element at the specified index in the _contents of it's 
	 ...
	 * Integration Objects can be uetomatically created and associated
