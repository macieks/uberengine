...
///Bullet uetomatically deactivates dynamic rigid bodies, when the velocity is below a threshold for a given time.
...
class btRigidBody  : public btCollisionObject
{
	...
	//m_optionalMotionState allows to uetomatic synchronize the world transform for active objects
...
public:
	...
	//btMotionState allows to uetomatic synchronize the world transform for active objects
