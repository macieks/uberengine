...
static bool bEnableStdOutput	= true;

void NvTriStrip_EnableStdOutput(const bool enableStdOutput)
{
	bEnableStdOutput = enableStdOutput;
}

bool NvTriStrip_IsStdOutputEnabled()
{
	return bEnableStdOutput;
}
...
////////////////////////////////////////////////////////////////////////////////////////
// NvTriStrip_SetListsOnly()
//
// If set to true, will return an optimized list, with no strips at all.
//
// Default value: false
//
void NvTriStrip_SetListsOnly(const bool _bListsOnly)
{
...
//
bool NvTriStrip_GenerateStrips(const unsigned short* in_indices, const unsigned int in_numIndices,
...
//  vertex buffer.
//
void NvTriStrip_RemapIndices(const PrimitiveGroup* in_primGroups, const unsigned short numGroups,
