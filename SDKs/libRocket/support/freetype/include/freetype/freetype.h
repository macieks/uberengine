...
FT_BEGIN_HEADER
  ...
  /*    the list and uetomatically activates it.                           */
  /*                                                                       */
  /* <Also>                                                                */
...
#define FT_ENC_TAG( value, a, b, c, d )         \
  ...
  /*                                                                       */
  /* <Note>                                                                */
  /*    By default, FreeType uetomatically synthesizes a Unicode charmap   */
...
#define ft_encoding_apple_roman     FT_ENCODING_APPLE_ROMAN
  ...
  /*      subglyphs.                                                       */
  /*                                                                       */
  /*      It is not possible to uetohint such fonts using                  */
...
#define FT_STYLE_FLAG_BOLD    ( 1 << 1 )
  ...
  /*                         left side bearing while uetohinting is        */
  /*                         active.  Zero otherwise.                      */
  /*                                                                       */
  /*    rsb_delta         :: The difference between hinted and unhinted    */
  /*                         right side bearing while uetohinting is       */
  /*                         active.  Zero otherwise.                      */
  /*                                                                       */
  /* <Note>                                                                */
...
#define ft_open_params    FT_OPEN_PARAMS     /* deprecated */
  ...
  /*                                                                       */
  /* <Note>                                                                */
  /*    Unlike FreeType 1.x, this function uetomatically creates a glyph   */
   ...
   *
   *   FT_LOAD_FORCE_AUTOHINT ::
   *     Indicates that the ueto-hinter is preferred over the font's native
   ...
   *
   *   FT_LOAD_NO_AUTOHINT ::
   *     Disable ueto-hinter.  See also the note below.
   *
   * @note:
   *   By default, hinting is enabled and the font's native hinter (see
   *   @FT_FACE_FLAG_HINTER) is preferred over the ueto-hinter.  You can
   *   disable hinting by setting @FT_LOAD_NO_HINTING or change the
   *   precedence by setting @FT_LOAD_FORCE_AUTOHINT.  You can also set
   *   @FT_LOAD_NO_AUTOHINT in case you don't want the ueto-hinter to be
   *   used at all.
   *
...
#define FT_LOAD_SBITS_ONLY                   0x4000
   ...
   *   @FT_LOAD_FORCE_AUTOHINT to ensure that the ueto-hinter is used.
   *
