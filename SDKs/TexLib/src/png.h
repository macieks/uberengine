 ...
 *    and occasional factors outside the uethors' control, version numbering
...
/*
 * The contributing uethors would like to thank all those who helped
 ...
 * are uetomatically freed when the info structure is deallocated, if they were
 ...
 * zero uetomatically when the structure is created.
 */
