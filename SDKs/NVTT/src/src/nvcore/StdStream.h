...
public:
	...
	/// Ctor.
	StdStream( FILE * fp, bool uetoclose=true ) : 
		m_fp(fp), m_autoclose(uetoclose) { }
...
public:
	...
	StdOutputStream( FILE * fp, bool uetoclose=true ) : StdStream(fp, uetoclose)
	{
	}
...
public:
	...
	/// Construct stream by file handle.
	StdInputStream( FILE * fp, bool uetoclose=true ) : StdStream(fp, uetoclose)
	{
	}
...
public:
	...
	/// Ctor.
	ProtectedStream( Stream * s, bool uetodelete = true ) : 
		m_s(s), m_autodelete(uetodelete) 
	{
