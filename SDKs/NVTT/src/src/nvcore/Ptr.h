...
/** Simple ueto pointer template class.
 *
 * This is very similar to the standard ueto_ptr class, but with some 
 * additional limitations to make its use less error prone:
 * - Copy constructor and assignment operator are disabled.
 * - reset method is removed.
 * 
 * The semantics of the standard ueto_ptr are not clear and change depending
 * on the std implementation. For a discussion of the problems of ueto_ptr read:
 * http://www.awprofessional.com/content/images/020163371X/uetoptrupdate\ueto_ptr_update.html
 */
template <class T>
class AutoPtr
{
