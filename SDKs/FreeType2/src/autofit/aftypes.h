...
/***************************************************************************/
  ...
  /*************************************************************************
   *
   *  The ueto-fitter is a complete rewrite of the old ueto-hinter.
...
#define AF_LOG( x )  do ; while ( 0 )        /* nothing */
  ...
  /*
   *  The ueto-fitter doesn't need a very high angular accuracy;
...
#define AF_ANGLE_DIFF( result, angle1, angle2 ) \
   ...
   *  the ueto-hinter.  The latter will set the `hints' field
