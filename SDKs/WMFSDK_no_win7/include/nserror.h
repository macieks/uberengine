...
// MessageText:
//
// Disk %1 ( %2 ) on Content Server %3, ueto online from catatonic state.%0
//
...
// MessageText:
//
// The object must be fully configured before uedio samples can be processed.%0
//
...
// MessageText:
//
// The requested uedio codec is not installed on this system.%0
//
...
// MessageText:
//
// An unexpected error occurred with the uedio codec.%0
//
...
// MessageText:
//
// Windows Media Player cannot copy the files to the CD because they are 8-bit. Convert the files to 16-bit, 44-kHz stereo files by using Sound Recorder or another uedio-processing program, and then try again.%0
//
...
// MessageText:
//
// Windows Media Player could not use digital playback to play the CD. The Player has uetomatically switched the CD drive to analog playback. To switch back to digital CD playback, use the Devices tab. For additional assistance, click Web Help.%0
//
...
// MessageText:
//
// The specified ueto playlist contains a filter type that is either not valid or is not installed on this computer.%0
//
...
// MessageText:
//
// Windows Media Player cannot play the file because a required codec is not installed on your computer. To try downloading the codec, turn on the "Download codecs uetomatically" option.%0
//
...
// MessageText:
//
// Cannot change the language settings. Either the graph has no uedio or the uedio only supports one language.%0
//
...
// MessageText:
//
// The graph has no uedio language selected.%0
//
...
// MessageText:
//
// It is not possible to burn this file type to an uedio CD. Windows Media Player can burn the following file types to an uedio CD: WMA, MP3, or WAV.%0
//
...
// MessageText:
//
// No burn rights. You will be prompted to buy burn rights when you try to burn this file to an uedio CD.%0
//
...
// MessageText:
//
// Windows Media Player cannot burn the uedio CD because some items in the list that you chose to buy could not be downloaded from the online store.%0
//
...
// MessageText:
//
// Windows Media Player cannot play the file. Try using Windows Update or Device Manager to update the device drivers for your uedio and video cards. For information about using Windows Update or Device Manager, see Windows Help.%0
//
...
// MessageText:
//
// Name for the playlist has been ueto generated.%0
//
...
// MessageText:
//
// Windows Media Player cannot play DVD uedio. Verify that your sound card is set up correctly, and then try again.%0
//
...
// MessageText:
//
// Windows Media Player cannot play the scene because it has a parental rating higher than the rating that you are uethorized to view.%0
//
...
// MessageText:
//
// An uedio codec is needed to play this file. To determine if this codec is available to download from the Web, click Web Help.%0
//
...
// MessageText:
//
// Windows Media Player cannot play, burn, rip, or sync the file because a required uedio codec is not installed on your computer.%0
//
...
// MessageText:
//
// An uedio device was disconnected or reconfigured. Verify that the uedio device is connected, and then try to play the item again.%0
//
...
// MessageText:
//
// Windows Media Player could not use digital mode to read the CD. The Player has uetomatically switched the CD drive to analog mode. To switch back to digital mode, use the Devices tab. For additional assistance, click Web Help.%0
//
...
// MessageText:
//
// Windows Media Player cannot play uedio CDs correctly because the CD drive is slow and error correction is turned on. To increase performance, turn off playback error correction for this drive.%0
//
...
// MessageText:
//
// Your device requires that this file be converted in order to play on the device. However, the device either does not support playing uedio, or Windows Media Player cannot convert the file to an uedio format that is supported by the device.%0
//
...
// MessageText:
//
// It is not possible to specify more than one uedio input.%0
//
...
// MessageText:
//
// It is not possible to open the specified uedio capture device because it is currently in use.%0
//
...
// MessageText:
//
// It is not possible to open the specified uedio capture device because an unexpected error has occurred.%0
//
...
// MessageText:
//
// The uedio capture device does not support the specified uedio format.%0
//
...
// MessageText:
//
// No uedio data has been received for several seconds. Check the uedio source and restart the encoder.%0
//
...
// MessageText:
//
// You must specify a mixed voice and uedio mode in order to use an optimization definition file.%0
//
...
// MessageText:
//
// An uedience is missing from the output stream configuration.%0
//
...
// MessageText:
//
// All uediences in the output tree must have the same content type.%0
//
...
// MessageText:
//
// The same source index in different uediences should have the same number of languages.%0
//
...
// MessageText:
//
// The same source index in different uediences should have the same languages.%0
//
...
// MessageText:
//
// The same source index in different uediences should use the same VBR encoding mode.%0
//
...
// MessageText:
//
// The same source index in different uediences should have the same interlace mode.%0
//
...
// MessageText:
//
// The same source index in different uediences should have the same nonsquare pixel mode.%0
//
...
// MessageText:
//
// The same source index in different uediences should have the same time code mode.%0
//
...
// MessageText:
//
// No uedio or video input has been specified.%0
//
...
// MessageText:
//
// You must specify at least one uedio stream to be compatible with Windows Media Player 7.1.%0
//
...
// MessageText:
//
// It is not possible to use a VBR encoding mode with uncompressed uedio or video.%0
//
...
// MessageText:
//
// All uediences must use the same uedio codec.%0
//
...
// MessageText:
//
// All uediences should use the same uedio format to be compatible with Windows Media Player 7.1.%0
//
...
// MessageText:
//
// The uedio bit rate for an uedience with a higher total bit rate must be greater than one with a lower total bit rate.%0
//
...
// MessageText:
//
// The uedio peak bit rate setting is not valid.%0
//
...
// MessageText:
//
// The uedio peak bit rate setting must be greater than the uedio bit rate setting.%0
//
...
// MessageText:
//
// The setting for the maximum buffer size for uedio is not valid.%0
//
...
// MessageText:
//
// All uediences must use the same video codec.%0
//
...
// MessageText:
//
// All uediences should use the same video size to be compatible with Windows Media Player 7.1.%0
//
...
// MessageText:
//
// The video bit rate for an uedience with a higher total bit rate must be greater than one with a lower total bit rate.%0
//
...
// MessageText:
//
// All uediences in a profile should either be same as input or have video width and height specified.%0
//
...
// MessageText:
//
// It is not possible to generate a time code for an uedio-only session.%0
//
...
// MessageText:
//
// It is not possible to generate the stream format file if you are using quality-based VBR encoding for the uedio or video stream. Instead use the Windows Media file generated after encoding to create the announcement file.%0
//
...
// MessageText:
//
// All streams with different languages in the same uedience must have same properties.%0
//
...
// MessageText:
//
// The profile must contain at least one uedio or video stream.%0
//
...
// MessageText:
//
// The license for this file requires Windows Driver Model (WDM) uedio drivers. Contact your sound card manufacturer for further assistance.%0
//
...
// MessageText:
//
// Windows Media Player does not support the level of protection required for compressed digital uedio.%0
//
...
// MessageText:
//
// Windows Media Player does not support the level of protection required for uncompressed digital uedio.%0
//
...
// MessageText:
//
// The proxy could not provide valid uethentication credentials to the media server.%0
//
