...
VOID CStatus::SetTextSz( INT nPane, LPWSTR lpsz )
{
...
VOID CStatus::SetTextFormatted( INT nPane, UINT uStrID, INT nData, LPWSTR pszData )
{
    ...
    LoadString( g_hInst, uStrID, szFormat, sizeof(szFormat) / sizeof(szFormat[0]) );
