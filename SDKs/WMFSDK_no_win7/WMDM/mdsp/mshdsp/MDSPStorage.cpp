...
Error:  
    ...
    hrLogDWORD( hr, "IMSDPStorage::GetStorageGlobals returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMSDPStorage::SetAttributes returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMSDPStorage::GetAttributes returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMSDPStorage::GetName returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMSDPStorage::GetDate returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMSDPStorage::GetSize returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMSDPStorage::GetRights returned 0x%08lx",  hr);
...
STDMETHODIMP CMDSPStorage::CreateStorage(DWORD dwAttributes, _WAVEFORMATEX * pFormat, LPWSTR pwszName, IMDSPStorage * * ppNewStorage)
{
    ...
    // strcpy(psz, g_szBackslash);
        hrTemp = StringCchCopyA(psz, ARRAYSIZE(m_szTmp) - (psz - m_szTmp), g_szBackslash);
        if (FAILED(hrTemp))
        {
            hr = hrTemp;
            goto Error;
...
Error:
    ...
    hrLogDWORD( hr, "IMSDPStorage::CreateStorage returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMSDPStorage::SendOpaqueCommand returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPObjectInfo::GetPlayLength returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPObjectInfo::SetPlayLength returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPObjectInfo::GetPlayOffset returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPObjectInfo::SetPlayOffset returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPObjectInfo::GetTotalLength returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPObjectInfo::GetLastPlayPosition returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPObjectInfo::GetLongestPlayPosition returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPObject::Open returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPObject::Read returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPObject::Write returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPObject::Delete returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPObject::Seek returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPObject::Rename returned 0x%08lx",  hr);
...
Error:  
    ...
    hrLogDWORD( hr, "IMDSPStorage::EnumStorage returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPObject::Close returned 0x%08lx",  hr);
...
DWORD MoveFunc( void *args )
{
    ...
    if(!pWcs) 
    {
        ...
        dwDestLen = wcslen(pCMArgs->wcsDst);
        if (dwDestLen == 0)
        {
        ...
        nHave = ARRAYSIZE(pCMArgs->wcsDst) - 1; // -1 for NULL terminator
        nHave -= dwDestLen;
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPObject::Move returned 0x%08lx",  hr);
