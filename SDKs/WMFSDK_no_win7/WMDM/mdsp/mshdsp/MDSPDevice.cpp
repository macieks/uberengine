...
Error:
    ...
    hrLogDWORD( hr, "IMDSPDevice::GetName returned 0x%08lx",  hr);
...
Error:   
    ...
    hrLogDWORD( hr, "IMDSPDevice::GetManufacturer returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPDevice::GetVersion returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPDevice::GetType returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPDevice::GetSerialNumber returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPDevice::GetPowerSource returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPDevice::GetStatus returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPDevice::GetDeviceIcon returned 0x%08lx",  hr);
...
STDMETHODIMP CMDSPDevice::SendOpaqueCommand(OPAQUECOMMAND *pCommand)
{
    ...
    {
        //
        // Command to exchange extended uethentication information
        //
        ...
        // In this simple extended uethentication scheme, the caller must
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPDevice::SendOpaqueCommand returned 0x%08lx",  hr);
...
STDMETHODIMP CMDSPDevice::GetStorage( LPCWSTR pszStorageName, IMDSPStorage** ppStorage )
{
    ...
    // Use wcsncpy instead of wcscpy for prefast
    wcsncpy(pStg->m_wcsName, pwszFileName, MAX_PATH);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPDevice::GetStorage returned 0x%08lx",  hr);
    return hr;
}
...
Error:
    hrLogDWORD( hr, "IMDSPDevice::GetSpecifyPropertyPages returned 0x%08lx",  hr);

    return hr;
}

STDMETHODIMP CMDSPDevice::GetCanonicalName( LPWSTR pwszPnPName, UINT nMaxChars )
{
    return E_NOTIMPL;
}
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPDeviceControl::GetDCStatus returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPDeviceControl::GetCapabilities returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPDeviceControl::Play returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPDeviceControl::Record returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPDeviceControl::Pause returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPDeviceControl::Resume returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPDeviceControl::Stop returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPDeviceControl::Seek returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPDevice::GetFormatSupport returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPDevice::EnumStorage returned 0x%08lx",  hr);
