...
Error:
    ...
    hrLogDWORD( hr, "IMDServiceProvider::GetDeviceCount returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDServiceProvider::EnumDevices returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IComponentAuthenticate::SACAuth returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IComponentAuthenticate::SACGetProtocols returned 0x%08lx",  hr);
