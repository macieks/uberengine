...
Error: 
    ...
    hrLogDWORD( hr, "IMSDPEnumDevice::Next returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMSDPEnumDevice::Skip returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMSDPEnumDevice::Reset returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMSDPEnumDevice::Clone returned 0x%08lx",  hr);
