...
#include "MDSPStorageGlobals.tmh"
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPStorageGlobals::GetCapabilities returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPStorageGlobals::GetSerialNumber returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPStorageGlobals::GetTotalFree returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPStorageGlobals::GetTotalBad returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPStorageGlobals::GetStatus returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPStorageGlobals::Initialize returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPStorageGlobals::GetDevice returned 0x%08lx",  hr);
...
Error:
    ...
    hrLogDWORD( hr, "IMDSPStorageGlobals::GetRootStorage returned 0x%08lx",  hr);
