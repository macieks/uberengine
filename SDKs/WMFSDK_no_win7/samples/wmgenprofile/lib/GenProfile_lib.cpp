...
// Desc: Initializes a WM_MEDIA_TYPE for uncompressed uedio.
//------------------------------------------------------------------------------
                                    ...
                                    WORD wBitsPerSample )
{
    ...
    do
    {
        ...
        //
        // Configure the WAVEFORMATEX structure for the uncompressed uedio
        //
...
// Desc: Creates an uedio stream and returns its configuration object.
//------------------------------------------------------------------------------
                                ...
                                LCID dwLanguage  )
{
    ...
    do
    {
        ...
        //
        // Configure the new uedio stream
        //
                                ...
                                LCID dwLanguage  )
{
    ...
    do
    {
        ...
        //
        // Create the media type for the uncompressed uedio
        //
