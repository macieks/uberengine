...
// MessageText:
//
//  "uedio_only" and "video_only" arguments are conflicting.%0
//
...
// MessageText:
//
//  Failed to remap uedio arguments.%0
//
...
//
#define E_CANT_CONNECT_MUX               ((DWORD)0xC0046030L)

//
// MessageId: E_CANT_CONNECT_FW
//
// MessageText:
//
//  Adding the File Writer failed.%0
//
#define E_CANT_CONNECT_FW                ((DWORD)0xC0046031L)

//
// MessageId: E_AVIMUX_NO_STREAM
//
// MessageText:
//
//  There is no stream to connect to the AVI Mux.%0
//
#define E_AVIMUX_NO_STREAM               ((DWORD)0xC0046032L)
...
// MessageText:
//
//  Can't obtain the input type for the uedio stream.%0
//
#define E_NO_INPUT_TYPE                  ((DWORD)0xC0046033L)

//
// MessageId: E_CREATE_EVENT
//
// MessageText:
//
//  Can't create event.%0
//
#define E_CREATE_EVENT                   ((DWORD)0xC0046034L)

//
// MessageId: E_NO_TAP_INTERFACE
//
// MessageText:
//
//  Tap filter doesn't supprt IPGI interface.%0
//
#define E_NO_TAP_INTERFACE               ((DWORD)0xC0046035L)

//
// MessageId: E_CONTEXT_REJECTED
//
// MessageText:
//
//  Context rejected.%0
//
#define E_CONTEXT_REJECTED               ((DWORD)0xC0046036L)

//
// MessageId: E_CALLBACK_REJECTED
//
// MessageText:
//
//  Callback rejected.%0
//
#define E_CALLBACK_REJECTED              ((DWORD)0xC0046037L)
...
// MessageText:
//
//  Pump Filter cannot be instantiated.%0
//
#define E_NO_PUMP                        ((DWORD)0xC0046038L)

//
// MessageId: E_NO_PUMP_INTERFACE
//
// MessageText:
//
//  Pump filter does't support ISPGI interface.%0
//
#define E_NO_PUMP_INTERFACE              ((DWORD)0xC0046039L)
...
// MessageText:
//
//  No seeking capabilities.%0
//
#define E_NO_SEEK                        ((DWORD)0xC004603DL)
...
// MessageText:
//
//  Requested uedio compression algorithm is not supported.%0
//
...
// MessageText:
//
//  Video encoder rejected the interlace mode.%0
//
...
//
// MessageId: E_VIDEO_INVALID_COMPLEXITY
//
// MessageText:
//
//  Video encoder rejected the encoder complexity setting.%0
//
#define E_VIDEO_COMPLEXITY_REJECTED       ((DWORD)0xC0046082L)
