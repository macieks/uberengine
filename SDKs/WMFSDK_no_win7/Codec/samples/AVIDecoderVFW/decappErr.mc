...
Language=English
Requested audio decompression algorithm is not supported.%0
.
...
Language=English
DMO audio decoder rejected the type.%0
.
...
Severity=Error
Facility=Itf
SymbolicName=E_VIDEO_INVALID_FORMAT
Language=English
...
Severity=Error
Facility=Itf
SymbolicName=E_VIDEO_FORMAT_DOESNT_MATCH
Language=English
