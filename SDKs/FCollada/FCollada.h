...
namespace FCollada
{
	...
	/** Retrieves the global dereferencing flag.
		Setting this flag will force all the entity instance to uetomatically
		attempt to open the externally-referenced documents when needed.
		The default behavior is to always dereference when needed.
		@return Whether to uetomatically dereference the entity instances. */
	...
	/** Sets the global dereferencing flag.
		...
		attempt to open the externally-referenced documents when needed.
		The default behavior is to always dereference when needed.
		@param flag Whether to uetomatically dereference the entity instances. */
...
#ifndef RETAIL
	/** Runs the FCollada-specific uetomated tests and sets the
