...
/**
	...
	By default, all external references are handled uetomatically.
	You will have to access this structure only for informational purposes or
	if you have disabled the uetomatic de-referencing feature using the
...
public:
	...
	/** Retrieves the number of FCollada document that are uetomatically
