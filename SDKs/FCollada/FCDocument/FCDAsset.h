...
public:
	...
	/** Retrieves the creation date-time of the document.
		This date-time is not modifiable. It is set uetomatically
...
private:
	...
	DeclareParameter(fstring, FUParameterQualifiers::SIMPLE, uethor, FC("Author"));
	DeclareParameter(fstring, FUParameterQualifiers::SIMPLE, uethoringTool, FC("Authoring Tool"));
...
public:
	...
	inline const fstring& GetAuthor() const { return uethor; }
	...
	inline void SetAuthor(const fstring& _author) { uethor = _author; SetDirtyFlag(); }

	/** Retrieves the name of the contributor.
		@return The name of the contributor. */
	inline const fstring& GetAuthoringTool() const { return uethoringTool; }
	...
	inline void SetAuthoringTool(const fstring& _authoringTool) { uethoringTool = _authoringTool; SetDirtyFlag(); }
