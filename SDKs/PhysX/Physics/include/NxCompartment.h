...
Note: You cannot release scene compartments explicitly, they are uetomatically released when the scene is released.
...
class NxCompartment
	...
	*/
	...
	/**
	\brief The device code that is specified when creating a compartment or the uetomatically
	...
	*/
	...
	creating the compartment (when using ueto-assign).
