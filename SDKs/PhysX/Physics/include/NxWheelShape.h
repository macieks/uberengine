...
//readout of internal state variables:
	...
	*/
	...
	otherShapeMaterialIndex is the material of the returned shape at the point of contact.  Because the tire model does not uetomatically respond to the material
