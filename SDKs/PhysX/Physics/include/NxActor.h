...
//@{
	...
	in certain cases (such as when a box jams in an uetomatic door), but currently
...
//@{
	...
	\note Mass properties of dynamic actors will not uetomatically be recomputed
	...
	<b>Sleeping:</b> Does <b>NOT</b> wake the actor up uetomatically.
...
//@}
	...
	*/
	...
	<b>Sleeping:</b> Changing the dominance group does <b>NOT</b> wake the actor up uetomatically.
...
//@{
	...
	Methods that uetomatically compute the center of mass such as updateMassFromShapes() as well as computing
	the mass and inertia using the actors shapes, will set this pose uetomatically.
...
//@{
	...
	is called sleeping. However, because the object uetomatically wakes up when it is either touched by an awake object,
...
/************************************************************************************************/
	...
	*/
	...
	Sleeping: Does NOT wake the actor up uetomatically.
	...
	*/
	...
	Note that trigger shapes possibly contained in the actor are uetomatically filtered out.
