...
class NxShape
	...
	*/
	...
	<b>Sleeping:</b> Does <b>NOT</b> wake the associated actor up uetomatically.
...
//@{
	...
	<i>Note:</i> Does not uetomatically update the inertia properties of the owning actor (if applicable); use NxActor::updateMassFromShapes() to do this.
