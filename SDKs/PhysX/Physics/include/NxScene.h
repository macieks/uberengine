...
//@{
	...
	*/
	...
	Such joints will be moved to a list of "dead joints" and uetomatically deleted upon 
...
//@{
	...
	<b>Sleeping:</b> Does <b>NOT</b> wake the actors up uetomatically.
	...
	*/
	...
	<b>Sleeping:</b> Does <b>NOT</b> wake the associated actors up uetomatically.
	...
	* if you set 
	...
	(g1, g2) to X, then (g2, g1) will implicitly and uetomatically be set to ~X, where:
	...
	<b>Sleeping:</b> Does <b>NOT</b> wake actors up uetomatically.
