...
public:
	...
	*/
	...
	The core actor's geometry is adjusted uetomatically. Its size also depends on the 
	...
	*/
	...
	outside of which cloth particle are uetomatically removed from the simulation. 
