...
class NxUserControllerHitReport
	...
	\return Specifies if to uetomatically apply forces to the touched actor.
	...
	*/
	...
	\return Specifies if to uetomatically apply forces to the touched controller.
...
*/
	...
	\param sharpness to prevent sudden height changes due to the uetostep feature, the motion can be smoothed using a feedback filter.
