...
GLUquadricObj* cone_fill;
GLUquadricObj* cone_point;
GLUquadricObj* cone_line;
GLfloat rotate=0;
...
void init_scene()
{
   ...
   cone_fill=gluNewQuadric();
   gluQuadricDrawStyle(cone_fill, GLU_FILL);
   cone_point=gluNewQuadric();
   gluQuadricDrawStyle(cone_point, GLU_POINT);
   cone_line=gluNewQuadric();
   gluQuadricDrawStyle(cone_line, GLU_LINE);
...
void render_scene()
{
   ...
   gluCylinder(cone_fill, 20.0f, 10.0f, 60.0f, 30, 30);
   glPopMatrix();
   ...
   glRotatef(-90.f, 1.f, 0.f, 0.f);
   glRotatef(rotate, 1.f, 0.0f, 0.0f);
   gluCylinder(cone_point, 20.0f, 10.0f, 60.0f, 60, 60);
   glPopMatrix();
   ...
   glRotatef(-90.f, 1.f, 0.f, 0.f);
   glRotatef(rotate, 1.f, 0.0f, 0.0f);
   gluCylinder(cone_line, 20.0f, 10.0f, 60.0f, 40, 40);
   glPopMatrix();
