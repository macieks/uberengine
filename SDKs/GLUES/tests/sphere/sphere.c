...
GLUquadricObj* sphere_fill;
GLUquadricObj* sphere_point;
GLUquadricObj* sphere_line;
GLfloat rotate=0;
...
void init_scene()
{
   ...
   sphere_fill=gluNewQuadric();
   gluQuadricDrawStyle(sphere_fill, GLU_FILL);
   sphere_point=gluNewQuadric();
   gluQuadricDrawStyle(sphere_point, GLU_POINT);
   sphere_line=gluNewQuadric();
   gluQuadricDrawStyle(sphere_line, GLU_LINE);
...
void render_scene()
{
   ...
   gluSphere(sphere_fill, 24.0f, 30, 30);
   glPopMatrix();
   ...
   glRotatef(-90.f, 1.f, 0.f, 0.f);
   glRotatef(rotate, 1.f, 0.0f, 0.0f);
   gluSphere(sphere_point, 24.0f, 60, 60);
   glPopMatrix();
   ...
   glRotatef(-90.f, 1.f, 0.f, 0.f);
   glRotatef(rotate, 1.f, 0.0f, 0.0f);
   gluSphere(sphere_line, 24.0f, 40, 40);
   glPopMatrix();
